...
darCNDC72 = data42[,"darwinBiochem_CNDC_7"]
...
darTEMP72 = data42[,"darwinBiochem_TEMP_7"]
...
darTURB72 = data42[,"darwinBiochem_TURB_7"]
```
...
darCNDCALL = data.frame(darCNDC02,darCNDC12,darCNDC22,darCNDC32,darCNDC42,darCNDC52,darCNDC62,darCNDC72)
darTEMPALL = data.frame(darTEMP02,darTEMP12,darTEMP22,darTEMP32,darTEMP42,darTEMP52,darTEMP62,darTEMP72)
darTURBALL = data.frame(darTURB02,darTURB12,darTURB22,darTURB32,darTURB42,darTURB52,darTURB62,darTURB72)
...
```{r}
datalm = data.frame(WINDSPDall)
WWSHlm = crossvalidlm(WWSH2,datalm,5,100)
```
...
sd(WWSHlm[,"WMAPE"])
sd(WWSHlm[,"rmse"])
bbe = c(mean(WWSHlm[,"arsq"]),mean(WWSHlm[,"WMAPE"]),mean(WWSHlm[,"rmse"]))
bbc = c(sd(WWSHlm[,"arsq"]),sd(WWSHlm[,"WMAPE"]),sd(WWSHlm[,"rmse"]))
data.frame(bbe,bbc)
...
```{r}
datalm = data.frame(data2[c(1,2,7)])
moda = glm(TEMP~.^2,data=datalm)
```

```{r}
moda = glm(TEMP~.,data = data2)
```
